...
-- Дамп структуры базы данных atvdoc
CREATE DATABASE IF NOT EXISTS `atvdoc` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `atvdoc`;


-- Дамп структуры для таблица atvdoc.oc_address
...
-- Дамп данных таблицы atvdoc.oc_api: 1 rows
DELETE FROM `oc_api`;
/*!40000 ALTER TABLE `oc_api` DISABLE KEYS */;
INSERT INTO `oc_api` (`api_id`, `username`, `key`, `status`, `date_added`, `date_modified`) VALUES
	(1, 'Default', '', 1, '2020-01-15 18:34:53', '2020-01-15 18:34:53');
/*!40000 ALTER TABLE `oc_api` ENABLE KEYS */;


-- Дамп структуры для таблица atvdoc.oc_api_ip
...
-- Дамп данных таблицы atvdoc.oc_article: 4 rows
...
-- Дамп структуры для таблица atvdoc.oc_article_description
...
-- Дамп данных таблицы atvdoc.oc_article_description: 8 rows
...
-- Дамп структуры для таблица atvdoc.oc_article_image
...
-- Дамп данных таблицы atvdoc.oc_article_image: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_article_related
...
-- Дамп данных таблицы atvdoc.oc_article_related: 6 rows
...
-- Дамп структуры для таблица atvdoc.oc_article_related_mn
...
-- Дамп данных таблицы atvdoc.oc_article_related_mn: 4 rows
...
-- Дамп структуры для таблица atvdoc.oc_article_related_product
...
-- Дамп данных таблицы atvdoc.oc_article_related_product: 15 rows
...
-- Дамп структуры для таблица atvdoc.oc_article_related_wb
...
-- Дамп данных таблицы atvdoc.oc_article_related_wb: 5 rows
...
-- Дамп структуры для таблица atvdoc.oc_article_to_blog_category
...
-- Дамп данных таблицы atvdoc.oc_article_to_blog_category: 7 rows
...
-- Дамп структуры для таблица atvdoc.oc_article_to_download
...
-- Дамп данных таблицы atvdoc.oc_article_to_download: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_article_to_layout
...
-- Дамп данных таблицы atvdoc.oc_article_to_layout: 4 rows
...
-- Дамп структуры для таблица atvdoc.oc_article_to_store
...
-- Дамп данных таблицы atvdoc.oc_article_to_store: 4 rows
...
-- Дамп структуры для таблица atvdoc.oc_attribute
...
-- Дамп данных таблицы atvdoc.oc_attribute: 11 rows
...
-- Дамп структуры для таблица atvdoc.oc_attribute_description
...
-- Дамп данных таблицы atvdoc.oc_attribute_description: 22 rows
...
-- Дамп структуры для таблица atvdoc.oc_attribute_group
...
-- Дамп данных таблицы atvdoc.oc_attribute_group: 4 rows
...
-- Дамп структуры для таблица atvdoc.oc_attribute_group_description
...
-- Дамп данных таблицы atvdoc.oc_attribute_group_description: 8 rows
...
-- Дамп структуры для таблица atvdoc.oc_banner
...
-- Дамп данных таблицы atvdoc.oc_banner: 3 rows
...
-- Дамп структуры для таблица atvdoc.oc_banner_image
...
-- Дамп данных таблицы atvdoc.oc_banner_image: 28 rows
...
INSERT INTO `oc_banner_image` (`banner_image_id`, `banner_id`, `language_id`, `title`, `link`, `image`, `sort_order`) VALUES
	...
	(129, 7, 1, '333', '', 'catalog/slides/d0439521882c0a16a5b95d8102a9bb14.jpg', 3),
	(106, 8, 1, 'RedBull', '', 'catalog/demo/manufacturer/redbull.png', 0),
	(105, 8, 1, 'NFL', '', 'catalog/demo/manufacturer/nfl.png', 0),
	(128, 7, 1, '222', 'index.php?route=product/product&amp;path=57&amp;product_id=49', 'catalog/slides/cbf9548972fe5ddf3edd1c00c4c5af71.jpg', 2),
	(127, 7, 1, '111', '', 'catalog/slides/5e25e9f91ad68f93a93ec30f8939f803.jpg', 1),
...
-- Дамп структуры для таблица atvdoc.oc_blog_category
...
-- Дамп данных таблицы atvdoc.oc_blog_category: 3 rows
...
-- Дамп структуры для таблица atvdoc.oc_blog_category_description
...
-- Дамп данных таблицы atvdoc.oc_blog_category_description: 6 rows
...
-- Дамп структуры для таблица atvdoc.oc_blog_category_path
...
-- Дамп данных таблицы atvdoc.oc_blog_category_path: 4 rows
...
-- Дамп структуры для таблица atvdoc.oc_blog_category_to_layout
...
-- Дамп данных таблицы atvdoc.oc_blog_category_to_layout: 3 rows
...
-- Дамп структуры для таблица atvdoc.oc_blog_category_to_store
...
-- Дамп данных таблицы atvdoc.oc_blog_category_to_store: 3 rows
...
-- Дамп структуры для таблица atvdoc.oc_cart
...
-- Дамп данных таблицы atvdoc.oc_cart: ~0 rows (приблизительно)
DELETE FROM `oc_cart`;
/*!40000 ALTER TABLE `oc_cart` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc_cart` ENABLE KEYS */;


-- Дамп структуры для таблица atvdoc.oc_category
...
-- Дамп данных таблицы atvdoc.oc_category: 38 rows
...
-- Дамп структуры для таблица atvdoc.oc_category_description
...
-- Дамп данных таблицы atvdoc.oc_category_description: 76 rows
...
-- Дамп структуры для таблица atvdoc.oc_category_filter
...
-- Дамп данных таблицы atvdoc.oc_category_filter: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_category_path
...
-- Дамп данных таблицы atvdoc.oc_category_path: 71 rows
...
-- Дамп структуры для таблица atvdoc.oc_category_to_layout
...
-- Дамп данных таблицы atvdoc.oc_category_to_layout: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_category_to_store
...
-- Дамп данных таблицы atvdoc.oc_category_to_store: 38 rows
...
-- Дамп структуры для таблица atvdoc.oc_country
...
-- Дамп данных таблицы atvdoc.oc_country: 253 rows
...
-- Дамп структуры для таблица atvdoc.oc_coupon
...
-- Дамп данных таблицы atvdoc.oc_coupon: 3 rows
...
-- Дамп структуры для таблица atvdoc.oc_coupon_category
...
-- Дамп данных таблицы atvdoc.oc_coupon_category: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_coupon_history
...
-- Дамп данных таблицы atvdoc.oc_coupon_history: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_coupon_product
...
-- Дамп данных таблицы atvdoc.oc_coupon_product: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_currency
...
-- Дамп данных таблицы atvdoc.oc_currency: 3 rows
DELETE FROM `oc_currency`;
/*!40000 ALTER TABLE `oc_currency` DISABLE KEYS */;
INSERT INTO `oc_currency` (`currency_id`, `title`, `code`, `symbol_left`, `symbol_right`, `decimal_place`, `value`, `status`, `date_modified`) VALUES
	(1, 'Рубль', 'RUB', '', 'р.', '2', 1.00000000, 1, '2020-01-16 14:29:49'),
...
-- Дамп структуры для таблица atvdoc.oc_customer
...
-- Дамп данных таблицы atvdoc.oc_customer_activity: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_customer_affiliate
...
-- Дамп данных таблицы atvdoc.oc_customer_affiliate: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_customer_approval
...
-- Дамп данных таблицы atvdoc.oc_customer_approval: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_customer_group
...
-- Дамп данных таблицы atvdoc.oc_customer_group: 1 rows
...
-- Дамп структуры для таблица atvdoc.oc_customer_group_description
...
-- Дамп данных таблицы atvdoc.oc_customer_group_description: 1 rows
...
-- Дамп структуры для таблица atvdoc.oc_customer_history
...
-- Дамп данных таблицы atvdoc.oc_customer_history: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_customer_ip
...
-- Дамп данных таблицы atvdoc.oc_customer_login: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_customer_online
...
-- Дамп данных таблицы atvdoc.oc_customer_online: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_customer_reward
...
-- Дамп данных таблицы atvdoc.oc_customer_reward: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_customer_search
...
-- Дамп данных таблицы atvdoc.oc_customer_search: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_customer_transaction
...
-- Дамп данных таблицы atvdoc.oc_customer_transaction: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_customer_wishlist
...
-- Дамп данных таблицы atvdoc.oc_customer_wishlist: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_custom_field
...
-- Дамп данных таблицы atvdoc.oc_custom_field_customer_group: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_custom_field_description
...
-- Дамп данных таблицы atvdoc.oc_custom_field_description: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_custom_field_value
...
-- Дамп данных таблицы atvdoc.oc_custom_field_value: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_custom_field_value_description
...
-- Дамп данных таблицы atvdoc.oc_custom_field_value_description: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_download
...
-- Дамп данных таблицы atvdoc.oc_download_description: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_event
...
-- Дамп данных таблицы atvdoc.oc_event: 33 rows
...
-- Дамп структуры для таблица atvdoc.oc_extension
...
-- Дамп данных таблицы atvdoc.oc_extension: 46 rows
...
-- Дамп структуры для таблица atvdoc.oc_extension_install
...
-- Дамп данных таблицы atvdoc.oc_extension_install: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_extension_path
...
-- Дамп данных таблицы atvdoc.oc_extension_path: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_filter
...
-- Дамп данных таблицы atvdoc.oc_filter_description: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_filter_group
...
-- Дамп данных таблицы atvdoc.oc_filter_group_description: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_geo_zone
...
-- Дамп данных таблицы atvdoc.oc_geo_zone: 2 rows
...
-- Дамп структуры для таблица atvdoc.oc_information
...
-- Дамп данных таблицы atvdoc.oc_information: 4 rows
...
-- Дамп структуры для таблица atvdoc.oc_information_description
...
-- Дамп данных таблицы atvdoc.oc_information_description: 8 rows
...
-- Дамп структуры для таблица atvdoc.oc_information_to_layout
...
-- Дамп данных таблицы atvdoc.oc_information_to_layout: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_information_to_store
...
-- Дамп данных таблицы atvdoc.oc_information_to_store: 4 rows
...
-- Дамп структуры для таблица atvdoc.oc_language
...
-- Дамп данных таблицы atvdoc.oc_language: 1 rows
...
-- Дамп структуры для таблица atvdoc.oc_layout
...
-- Дамп данных таблицы atvdoc.oc_layout: 17 rows
...
-- Дамп структуры для таблица atvdoc.oc_layout_module
...
-- Дамп данных таблицы atvdoc.oc_layout_module: 23 rows
...
-- Дамп структуры для таблица atvdoc.oc_layout_route
...
-- Дамп данных таблицы atvdoc.oc_layout_route: 17 rows
...
-- Дамп структуры для таблица atvdoc.oc_length_class
...
-- Дамп данных таблицы atvdoc.oc_length_class: 3 rows
...
-- Дамп структуры для таблица atvdoc.oc_length_class_description
...
-- Дамп данных таблицы atvdoc.oc_length_class_description: 6 rows
...
-- Дамп структуры для таблица atvdoc.oc_location
...
-- Дамп данных таблицы atvdoc.oc_manufacturer: 6 rows
...
-- Дамп структуры для таблица atvdoc.oc_manufacturer_description
...
-- Дамп данных таблицы atvdoc.oc_manufacturer_description: 12 rows
...
-- Дамп структуры для таблица atvdoc.oc_manufacturer_to_layout
...
-- Дамп данных таблицы atvdoc.oc_manufacturer_to_layout: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_manufacturer_to_store
...
-- Дамп данных таблицы atvdoc.oc_manufacturer_to_store: 6 rows
...
-- Дамп структуры для таблица atvdoc.oc_marketing
...
-- Дамп данных таблицы atvdoc.oc_module: 9 rows
...
INSERT INTO `oc_module` (`module_id`, `name`, `code`, `setting`) VALUES
	...
	(36, 'Главная Преимущества', 'html', '{"name":"\\u0413\\u043b\\u0430\\u0432\\u043d\\u0430\\u044f \\u041f\\u0440\\u0435\\u0438\\u043c\\u0443\\u0449\\u0435\\u0441\\u0442\\u0432\\u0430","module_description":{"1":{"title":"\\u0413\\u043b\\u0430\\u0432\\u043d\\u0430\\u044f \\u041f\\u0440\\u0435\\u0438\\u043c\\u0443\\u0449\\u0435\\u0441\\u0442\\u0432\\u0430","description":"&lt;div class=&quot;advantages&quot;&gt;\\r\\n\\t\\t\\t&lt;div class=&quot;advantages-item&quot;&gt;\\t\\t\\r\\n\\t\\t\\t&lt;div class=&quot;advantages-item-icon-wrap&quot;&gt;\\r\\n\\t\\t\\t\\t&lt;div class=&quot;advantages-item-icon&quot;&gt;\\r\\n\\t\\t\\t\\t\\t&lt;i class=&quot;fa fa-truck&quot;&gt;&lt;\\/i&gt;\\r\\n\\t\\t\\t\\t&lt;\\/div&gt;\\r\\n\\t\\t\\t&lt;\\/div&gt;\\r\\n\\t\\t\\t&lt;div class=&quot;advantages-item-text&quot;&gt;\\r\\n\\t\\t\\t\\t\\u0411\\u0435\\u0441\\u043f\\u043b\\u0430\\u0442\\u043d\\u0430\\u044f \\u0434\\u043e\\u0441\\u0442\\u0430\\u0432\\u043a\\u0430 \\u043f\\u043e \\u041c\\u043e\\u0441\\u043a\\u0432\\u0435 \\u043e\\u0442 5000 \\u0440\\u0443\\u0431.\\t\\t\\t&lt;\\/div&gt;\\r\\n\\t\\t&lt;\\/div&gt;\\r\\n\\t\\t\\t&lt;div class=&quot;advantages-item&quot;&gt;\\t\\t\\r\\n\\t\\t\\t&lt;div class=&quot;advantages-item-icon-wrap&quot;&gt;\\r\\n\\t\\t\\t\\t&lt;div class=&quot;advantages-item-icon&quot;&gt;\\r\\n\\t\\t\\t\\t\\t&lt;i class=&quot;fa fa-star-o&quot;&gt;&lt;\\/i&gt;\\r\\n\\t\\t\\t\\t&lt;\\/div&gt;\\r\\n\\t\\t\\t&lt;\\/div&gt;\\r\\n\\t\\t\\t&lt;div class=&quot;advantages-item-text&quot;&gt;\\r\\n\\t\\t\\t\\t\\u0412\\u0441\\u0435 \\u0442\\u043e\\u0432\\u0430\\u0440\\u044b \\u0441\\u0435\\u0440\\u0442\\u0438\\u0444\\u0438\\u0446\\u0438\\u0440\\u043e\\u0432\\u0430\\u043d\\u044b\\t\\t\\t&lt;\\/div&gt;\\r\\n\\t\\t&lt;\\/div&gt;\\r\\n\\t\\t\\t&lt;div class=&quot;advantages-item&quot;&gt;\\t\\t\\r\\n\\t\\t\\t&lt;div class=&quot;advantages-item-icon-wrap&quot;&gt;\\r\\n\\t\\t\\t\\t&lt;div class=&quot;advantages-item-icon&quot;&gt;\\r\\n\\t\\t\\t\\t\\t&lt;i class=&quot;fa fa-thumbs-o-up&quot;&gt;&lt;\\/i&gt;\\r\\n\\t\\t\\t\\t&lt;\\/div&gt;\\r\\n\\t\\t\\t&lt;\\/div&gt;\\r\\n\\t\\t\\t&lt;div class=&quot;advantages-item-text&quot;&gt;\\r\\n\\t\\t\\t\\t\\u0412\\u043e\\u0437\\u043c\\u043e\\u0436\\u043d\\u0430 \\u043f\\u043e\\u043a\\u0443\\u043f\\u043a\\u0430 \\u043b\\u044e\\u0431\\u043e\\u0433\\u043e \\u0442\\u043e\\u0432\\u0430\\u0440\\u0430 \\u0432 \\u043a\\u0440\\u0435\\u0434\\u0438\\u0442\\t\\t\\t&lt;\\/div&gt;\\r\\n\\t\\t&lt;\\/div&gt;\\r\\n\\t\\t\\t&lt;div class=&quot;advantages-item&quot;&gt;\\t\\t\\r\\n\\t\\t\\t&lt;div class=&quot;advantages-item-icon-wrap&quot;&gt;\\r\\n\\t\\t\\t\\t&lt;div class=&quot;advantages-item-icon&quot;&gt;\\r\\n\\t\\t\\t\\t\\t&lt;i class=&quot;fa fa-history&quot;&gt;&lt;\\/i&gt;\\r\\n\\t\\t\\t\\t&lt;\\/div&gt;\\r\\n\\t\\t\\t&lt;\\/div&gt;\\r\\n\\t\\t\\t&lt;div class=&quot;advantages-item-text&quot;&gt;\\r\\n\\t\\t\\t\\t\\u0412\\u043e\\u0437\\u043c\\u043e\\u0436\\u043d\\u0430 \\u0434\\u043e\\u0441\\u0442\\u0430\\u0432\\u043a\\u0430 \\u00ab\\u0421\\u0435\\u0433\\u043e\\u0434\\u043d\\u044f \\u043d\\u0430 \\u0441\\u0435\\u0433\\u043e\\u0434\\u043d\\u044f\\u00bb\\t\\t\\t&lt;\\/div&gt;\\r\\n\\t\\t&lt;\\/div&gt;\\r\\n&lt;\\/div&gt;\\t"}},"status":"1"}');
/*!40000 ALTER TABLE `oc_module` ENABLE KEYS */;


-- Дамп структуры для таблица atvdoc.oc_option
...
-- Дамп данных таблицы atvdoc.oc_option: 11 rows
...
-- Дамп структуры для таблица atvdoc.oc_option_description
...
-- Дамп данных таблицы atvdoc.oc_option_description: 22 rows
...
-- Дамп структуры для таблица atvdoc.oc_option_value
...
-- Дамп данных таблицы atvdoc.oc_option_value: 14 rows
...
-- Дамп структуры для таблица atvdoc.oc_option_value_description
...
-- Дамп данных таблицы atvdoc.oc_option_value_description: 14 rows
...
-- Дамп структуры для таблица atvdoc.oc_order
...
-- Дамп данных таблицы atvdoc.oc_order_history: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_order_option
...
-- Дамп данных таблицы atvdoc.oc_order_product: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_order_recurring
...
-- Дамп данных таблицы atvdoc.oc_order_recurring: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_order_recurring_transaction
...
-- Дамп данных таблицы atvdoc.oc_order_recurring_transaction: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_order_shipment
...
-- Дамп данных таблицы atvdoc.oc_order_shipment: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_order_status
...
-- Дамп данных таблицы atvdoc.oc_order_status: 28 rows
...
-- Дамп структуры для таблица atvdoc.oc_order_total
...
-- Дамп данных таблицы atvdoc.oc_order_voucher: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_product
...
-- Дамп данных таблицы atvdoc.oc_product: 19 rows
...
INSERT INTO `oc_product` (`product_id`, `model`, `sku`, `upc`, `ean`, `jan`, `isbn`, `mpn`, `location`, `quantity`, `stock_status_id`, `image`, `manufacturer_id`, `shipping`, `price`, `points`, `tax_class_id`, `date_available`, `weight`, `weight_class_id`, `length`, `width`, `height`, `length_class_id`, `subtract`, `minimum`, `sort_order`, `status`, `viewed`, `date_added`, `date_modified`, `noindex`) VALUES
	...
	(42, 'Product 15', '', '', '', '', '', '', '', 990, 5, 'catalog/demo/apple_cinema_30.jpg', 8, 1, 100.0000, 400, 9, '2009-02-04', 12.50000000, 1, 1.00000000, 2.00000000, 3.00000000, 1, 1, 2, 0, 1, 0, '2009-02-03 21:07:37', '2017-07-26 22:30:20', 0),
...
-- Дамп структуры для таблица atvdoc.oc_product_attribute
...
-- Дамп данных таблицы atvdoc.oc_product_attribute: 5 rows
...
-- Дамп структуры для таблица atvdoc.oc_product_description
...
-- Дамп данных таблицы atvdoc.oc_product_description: 38 rows
...
-- Дамп структуры для таблица atvdoc.oc_product_discount
...
-- Дамп данных таблицы atvdoc.oc_product_discount: 3 rows
...
-- Дамп структуры для таблица atvdoc.oc_product_filter
...
-- Дамп данных таблицы atvdoc.oc_product_filter: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_product_image
...
-- Дамп данных таблицы atvdoc.oc_product_image: 61 rows
...
-- Дамп структуры для таблица atvdoc.oc_product_option
...
-- Дамп данных таблицы atvdoc.oc_product_option: 12 rows
...
-- Дамп структуры для таблица atvdoc.oc_product_option_value
...
-- Дамп данных таблицы atvdoc.oc_product_option_value: 16 rows
...
-- Дамп структуры для таблица atvdoc.oc_product_recurring
...
-- Дамп данных таблицы atvdoc.oc_product_recurring: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_product_related
...
-- Дамп данных таблицы atvdoc.oc_product_related: 4 rows
...
-- Дамп структуры для таблица atvdoc.oc_product_related_article
...
-- Дамп данных таблицы atvdoc.oc_product_related_article: 7 rows
...
-- Дамп структуры для таблица atvdoc.oc_product_related_mn
CREATE TABLE IF NOT EXISTS `oc_product_related_mn` (
  `product_id` int(11) NOT NULL,
  `manufacturer_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- Дамп данных таблицы atvdoc.oc_product_related_mn: 4 rows
DELETE FROM `oc_product_related_mn`;
...
-- Дамп структуры для таблица atvdoc.oc_product_related_wb
CREATE TABLE IF NOT EXISTS `oc_product_related_wb` (
  `product_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- Дамп данных таблицы atvdoc.oc_product_related_wb: 6 rows
DELETE FROM `oc_product_related_wb`;
...
-- Дамп структуры для таблица atvdoc.oc_product_reward
...
-- Дамп данных таблицы atvdoc.oc_product_reward: 19 rows
...
-- Дамп структуры для таблица atvdoc.oc_product_special
...
-- Дамп данных таблицы atvdoc.oc_product_special: 3 rows
...
-- Дамп структуры для таблица atvdoc.oc_product_to_category
...
-- Дамп данных таблицы atvdoc.oc_product_to_category: 35 rows
...
-- Дамп структуры для таблица atvdoc.oc_product_to_download
...
-- Дамп данных таблицы atvdoc.oc_product_to_download: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_product_to_layout
...
-- Дамп данных таблицы atvdoc.oc_product_to_layout: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_product_to_store
...
-- Дамп данных таблицы atvdoc.oc_product_to_store: 19 rows
...
-- Дамп структуры для таблица atvdoc.oc_recurring
...
-- Дамп данных таблицы atvdoc.oc_recurring_description: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_return
...
-- Дамп данных таблицы atvdoc.oc_return_action: 6 rows
...
-- Дамп структуры для таблица atvdoc.oc_return_history
...
-- Дамп данных таблицы atvdoc.oc_return_history: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_return_reason
...
-- Дамп данных таблицы atvdoc.oc_return_reason: 10 rows
...
-- Дамп структуры для таблица atvdoc.oc_return_status
...
-- Дамп данных таблицы atvdoc.oc_return_status: 6 rows
...
-- Дамп структуры для таблица atvdoc.oc_review
...
-- Дамп данных таблицы atvdoc.oc_review_article: 1 rows
...
-- Дамп структуры для таблица atvdoc.oc_seo_url
...
-- Дамп данных таблицы atvdoc.oc_seo_url: 136 rows
...
-- Дамп структуры для таблица atvdoc.oc_session
...
-- Дамп данных таблицы atvdoc.oc_session: ~7 rows (приблизительно)
DELETE FROM `oc_session`;
/*!40000 ALTER TABLE `oc_session` DISABLE KEYS */;
INSERT INTO `oc_session` (`session_id`, `data`, `expire`) VALUES
	('0616531eae5c0e71b6e64f4011', '{"language":"ru-ru","currency":"RUB"}', '2020-01-16 12:12:28'),
	('0ec3c7d3bce3e540b08611518d', '{"language":"ru-ru","currency":"RUB","user_id":"1","user_token":"YuBmNswTBAfsw58JoK6ZDuZ6RHU0Gk2U"}', '2020-01-16 15:25:57'),
	('22ba3d2a3500d9193b7aec7512', '{"language":"ru-ru","currency":"RUB"}', '2020-01-16 12:15:34'),
	('7eb38b11dce97d796eff151f9f', '{"language":"ru-ru","currency":"RUB"}', '2020-01-16 12:17:28'),
	('81935d439783fd5cc67dc06e3b', '{"language":"ru-ru","currency":"RUB","user_id":"1","user_token":"5NQ4eZhNaPO0aCKLt0QENNUWnVZ0Utap"}', '2020-01-16 03:59:23'),
	('94bea506239bf5a453124f650c', '{"language":"ru-ru","currency":"RUB"}', '2020-01-16 18:41:53'),
	('fef05086c5bfbfa19d101a75cc', '{"language":"ru-ru","currency":"RUB"}', '2020-01-16 12:16:49');
/*!40000 ALTER TABLE `oc_session` ENABLE KEYS */;


-- Дамп структуры для таблица atvdoc.oc_setting
...
-- Дамп данных таблицы atvdoc.oc_setting: 251 rows
DELETE FROM `oc_setting`;
/*!40000 ALTER TABLE `oc_setting` DISABLE KEYS */;
INSERT INTO `oc_setting` (`setting_id`, `store_id`, `code`, `key`, `value`, `serialized`) VALUES
	(654, 0, 'theme_default', 'theme_default_image_location_height', '50', 0),
	(860, 0, 'config', 'config_error_display', '1', 0),
	(861, 0, 'config', 'config_error_log', '1', 0),
	(862, 0, 'config', 'config_error_filename', 'error.log', 0),
	(863, 0, 'config', 'config_seo_pro', '0', 0),
	(864, 0, 'config', 'config_seo_url_include_path', '0', 0),
	(865, 0, 'config', 'config_seo_url_cache', '0', 0),
	(866, 0, 'config', 'config_seopro_addslash', '0', 0),
	(867, 0, 'config', 'config_seopro_lowercase', '0', 0),
	(868, 0, 'config', 'config_page_postfix', '', 0),
	(869, 0, 'config', 'config_valide_param_flag', '0', 0),
	(870, 0, 'config', 'config_valide_params', 'tracking\r\nutm_source\r\nutm_campaign\r\nutm_medium\r\ntype\r\nsource\r\nblock\r\nposition\r\nkeyword\r\nyclid\r\ngclid', 0),
	(653, 0, 'theme_default', 'theme_default_image_location_width', '268', 0),
	(4, 0, 'voucher', 'total_voucher_sort_order', '8', 0),
	(5, 0, 'voucher', 'total_voucher_status', '1', 0),
	(859, 0, 'config', 'config_file_mime_allowed', 'text/plain\r\nimage/png\r\nimage/jpeg\r\nimage/gif\r\nimage/bmp\r\nimage/tiff\r\nimage/svg+xml\r\napplication/zip\r\n&quot;application/zip&quot;\r\napplication/x-zip\r\n&quot;application/x-zip&quot;\r\napplication/x-zip-compressed\r\n&quot;application/x-zip-compressed&quot;\r\napplication/rar\r\n&quot;application/rar&quot;\r\napplication/x-rar\r\n&quot;application/x-rar&quot;\r\napplication/x-rar-compressed\r\n&quot;application/x-rar-compressed&quot;\r\napplication/octet-stream\r\n&quot;application/octet-stream&quot;\r\naudio/mpeg\r\nvideo/quicktime\r\napplication/pdf', 0),
	(858, 0, 'config', 'config_file_ext_allowed', 'zip\r\ntxt\r\npng\r\njpe\r\njpeg\r\njpg\r\ngif\r\nbmp\r\nico\r\ntiff\r\ntif\r\nsvg\r\nsvgz\r\nzip\r\nrar\r\nmsi\r\ncab\r\nmp3\r\nqt\r\nmov\r\npdf\r\npsd\r\nai\r\neps\r\nps\r\ndoc', 0),
	(857, 0, 'config', 'config_file_max_size', '300000', 0),
	(852, 0, 'config', 'config_compression', '0', 0),
	(853, 0, 'config', 'config_secure', '0', 0),
	(854, 0, 'config', 'config_password', '1', 0),
	(855, 0, 'config', 'config_shared', '0', 0),
	(856, 0, 'config', 'config_encryption', '', 0),
	(851, 0, 'config', 'config_robots', 'abot\r\ndbot\r\nebot\r\nhbot\r\nkbot\r\nlbot\r\nmbot\r\nnbot\r\nobot\r\npbot\r\nrbot\r\nsbot\r\ntbot\r\nvbot\r\nybot\r\nzbot\r\nbot.\r\nbot/\r\n_bot\r\n.bot\r\n/bot\r\n-bot\r\n:bot\r\n(bot\r\ncrawl\r\nslurp\r\nspider\r\nseek\r\naccoona\r\nacoon\r\nadressendeutschland\r\nah-ha.com\r\nahoy\r\naltavista\r\nananzi\r\nanthill\r\nappie\r\narachnophilia\r\narale\r\naraneo\r\naranha\r\narchitext\r\naretha\r\narks\r\nasterias\r\natlocal\r\natn\r\natomz\r\naugurfind\r\nbackrub\r\nbannana_bot\r\nbaypup\r\nbdfetch\r\nbig brother\r\nbiglotron\r\nbjaaland\r\nblackwidow\r\nblaiz\r\nblog\r\nblo.\r\nbloodhound\r\nboitho\r\nbooch\r\nbradley\r\nbutterfly\r\ncalif\r\ncassandra\r\nccubee\r\ncfetch\r\ncharlotte\r\nchurl\r\ncienciaficcion\r\ncmc\r\ncollective\r\ncomagent\r\ncombine\r\ncomputingsite\r\ncsci\r\ncurl\r\ncusco\r\ndaumoa\r\ndeepindex\r\ndelorie\r\ndepspid\r\ndeweb\r\ndie blinde kuh\r\ndigger\r\nditto\r\ndmoz\r\ndocomo\r\ndownload express\r\ndtaagent\r\ndwcp\r\nebiness\r\nebingbong\r\ne-collector\r\nejupiter\r\nemacs-w3 search engine\r\nesther\r\nevliya celebi\r\nezresult\r\nfalcon\r\nfelix ide\r\nferret\r\nfetchrover\r\nfido\r\nfindlinks\r\nfireball\r\nfish search\r\nfouineur\r\nfunnelweb\r\ngazz\r\ngcreep\r\ngenieknows\r\ngetterroboplus\r\ngeturl\r\nglx\r\ngoforit\r\ngolem\r\ngrabber\r\ngrapnel\r\ngralon\r\ngriffon\r\ngromit\r\ngrub\r\ngulliver\r\nhamahakki\r\nharvest\r\nhavindex\r\nhelix\r\nheritrix\r\nhku www octopus\r\nhomerweb\r\nhtdig\r\nhtml index\r\nhtml_analyzer\r\nhtmlgobble\r\nhubater\r\nhyper-decontextualizer\r\nia_archiver\r\nibm_planetwide\r\nichiro\r\niconsurf\r\niltrovatore\r\nimage.kapsi.net\r\nimagelock\r\nincywincy\r\nindexer\r\ninfobee\r\ninformant\r\ningrid\r\ninktomisearch.com\r\ninspector web\r\nintelliagent\r\ninternet shinchakubin\r\nip3000\r\niron33\r\nisraeli-search\r\nivia\r\njack\r\njakarta\r\njavabee\r\njetbot\r\njumpstation\r\nkatipo\r\nkdd-explorer\r\nkilroy\r\nknowledge\r\nkototoi\r\nkretrieve\r\nlabelgrabber\r\nlachesis\r\nlarbin\r\nlegs\r\nlibwww\r\nlinkalarm\r\nlink validator\r\nlinkscan\r\nlockon\r\nlwp\r\nlycos\r\nmagpie\r\nmantraagent\r\nmapoftheinternet\r\nmarvin/\r\nmattie\r\nmediafox\r\nmediapartners\r\nmercator\r\nmerzscope\r\nmicrosoft url control\r\nminirank\r\nmiva\r\nmj12\r\nmnogosearch\r\nmoget\r\nmonster\r\nmoose\r\nmotor\r\nmultitext\r\nmuncher\r\nmuscatferret\r\nmwd.search\r\nmyweb\r\nnajdi\r\nnameprotect\r\nnationaldirectory\r\nnazilla\r\nncsa beta\r\nnec-meshexplorer\r\nnederland.zoek\r\nnetcarta webmap engine\r\nnetmechanic\r\nnetresearchserver\r\nnetscoop\r\nnewscan-online\r\nnhse\r\nnokia6682/\r\nnomad\r\nnoyona\r\nnutch\r\nnzexplorer\r\nobjectssearch\r\noccam\r\nomni\r\nopen text\r\nopenfind\r\nopenintelligencedata\r\norb search\r\nosis-project\r\npack rat\r\npageboy\r\npagebull\r\npage_verifier\r\npanscient\r\nparasite\r\npartnersite\r\npatric\r\npear.\r\npegasus\r\nperegrinator\r\npgp key agent\r\nphantom\r\nphpdig\r\npicosearch\r\npiltdownman\r\npimptrain\r\npinpoint\r\npioneer\r\npiranha\r\nplumtreewebaccessor\r\npogodak\r\npoirot\r\npompos\r\npoppelsdorf\r\npoppi\r\npopular iconoclast\r\npsycheclone\r\npublisher\r\npython\r\nrambler\r\nraven search\r\nroach\r\nroad runner\r\nroadhouse\r\nrobbie\r\nrobofox\r\nrobozilla\r\nrules\r\nsalty\r\nsbider\r\nscooter\r\nscoutjet\r\nscrubby\r\nsearch.\r\nsearchprocess\r\nsemanticdiscovery\r\nsenrigan\r\nsg-scout\r\nshai\'hulud\r\nshark\r\nshopwiki\r\nsidewinder\r\nsift\r\nsilk\r\nsimmany\r\nsite searcher\r\nsite valet\r\nsitetech-rover\r\nskymob.com\r\nsleek\r\nsmartwit\r\nsna-\r\nsnappy\r\nsnooper\r\nsohu\r\nspeedfind\r\nsphere\r\nsphider\r\nspinner\r\nspyder\r\nsteeler/\r\nsuke\r\nsuntek\r\nsupersnooper\r\nsurfnomore\r\nsven\r\nsygol\r\nszukacz\r\ntach black widow\r\ntarantula\r\ntempleton\r\n/teoma\r\nt-h-u-n-d-e-r-s-t-o-n-e\r\ntheophrastus\r\ntitan\r\ntitin\r\ntkwww\r\ntoutatis\r\nt-rex\r\ntutorgig\r\ntwiceler\r\ntwisted\r\nucsd\r\nudmsearch\r\nurl check\r\nupdated\r\nvagabondo\r\nvalkyrie\r\nverticrawl\r\nvictoria\r\nvision-search\r\nvolcano\r\nvoyager/\r\nvoyager-hc\r\nw3c_validator\r\nw3m2\r\nw3mir\r\nwalker\r\nwallpaper\r\nwanderer\r\nwauuu\r\nwavefire\r\nweb core\r\nweb hopper\r\nweb wombat\r\nwebbandit\r\nwebcatcher\r\nwebcopy\r\nwebfoot\r\nweblayers\r\nweblinker\r\nweblog monitor\r\nwebmirror\r\nwebmonkey\r\nwebquest\r\nwebreaper\r\nwebsitepulse\r\nwebsnarf\r\nwebstolperer\r\nwebvac\r\nwebwalk\r\nwebwatch\r\nwebwombat\r\nwebzinger\r\nwhizbang\r\nwhowhere\r\nwild ferret\r\nworldlight\r\nwwwc\r\nwwwster\r\nxenu\r\nxget\r\nxift\r\nxirq\r\nyandex\r\nyanga\r\nyeti\r\nyodao\r\nzao\r\nzippp\r\nzyborg', 0),
	(850, 0, 'config', 'config_seo_url', '0', 0),
	(849, 0, 'config', 'config_maintenance', '0', 0),
	(848, 0, 'config', 'config_mail_alert_email', '', 0),
	(847, 0, 'config', 'config_mail_alert', '["order"]', 1),
	(846, 0, 'config', 'config_mail_smtp_timeout', '5', 0),
	(845, 0, 'config', 'config_mail_smtp_port', '25', 0),
	(842, 0, 'config', 'config_mail_smtp_hostname', '', 0),
	(844, 0, 'config', 'config_mail_smtp_password', '', 0),
	(843, 0, 'config', 'config_mail_smtp_username', '', 0),
	(841, 0, 'config', 'config_mail_parameter', '', 0),
	(840, 0, 'config', 'config_mail_engine', 'mail', 0),
	(839, 0, 'config', 'config_icon', 'catalog/favicon.png', 0),
	(838, 0, 'config', 'config_logo', 'catalog/logo.png', 0),
	(837, 0, 'config', 'config_captcha_page', '["review","return","contact"]', 1),
	(836, 0, 'config', 'config_captcha', '', 0),
	(835, 0, 'config', 'config_return_status_id', '2', 0),
	(834, 0, 'config', 'config_return_id', '0', 0),
	(833, 0, 'config', 'config_affiliate_id', '4', 0),
	(832, 0, 'config', 'config_affiliate_commission', '5', 0),
	(831, 0, 'config', 'config_affiliate_auto', '0', 0),
	...
	(652, 0, 'theme_default', 'theme_default_image_cart_height', '47', 0),
	(650, 0, 'theme_default', 'theme_default_image_wishlist_height', '47', 0),
	(651, 0, 'theme_default', 'theme_default_image_cart_width', '47', 0),
	(648, 0, 'theme_default', 'theme_default_image_compare_height', '90', 0),
	(649, 0, 'theme_default', 'theme_default_image_wishlist_width', '47', 0),
	(647, 0, 'theme_default', 'theme_default_image_compare_width', '90', 0),
	(646, 0, 'theme_default', 'theme_default_image_related_height', '200', 0),
	(645, 0, 'theme_default', 'theme_default_image_related_width', '200', 0),
	(644, 0, 'theme_default', 'theme_default_image_additional_height', '74', 0),
	(643, 0, 'theme_default', 'theme_default_image_additional_width', '74', 0),
	(642, 0, 'theme_default', 'theme_default_image_product_height', '228', 0),
	(641, 0, 'theme_default', 'theme_default_image_product_width', '228', 0),
	(640, 0, 'theme_default', 'theme_default_image_popup_height', '500', 0),
	(639, 0, 'theme_default', 'theme_default_image_popup_width', '500', 0),
	(638, 0, 'theme_default', 'theme_default_image_thumb_height', '228', 0),
	(637, 0, 'theme_default', 'theme_default_image_thumb_width', '228', 0),
	(636, 0, 'theme_default', 'theme_default_image_manufacturer_height', '80', 0),
	(634, 0, 'theme_default', 'theme_default_image_category_height', '80', 0),
	(635, 0, 'theme_default', 'theme_default_image_manufacturer_width', '80', 0),
	(633, 0, 'theme_default', 'theme_default_image_category_width', '80', 0),
	(631, 0, 'theme_default', 'theme_default_product_limit', '15', 0),
	(632, 0, 'theme_default', 'theme_default_product_description_length', '100', 0),
	...
	(655, 0, 'developer', 'developer_theme', '0', 0),
	...
	(830, 0, 'config', 'config_affiliate_approval', '0', 0),
	(829, 0, 'config', 'config_affiliate_group_id', '1', 0),
	(828, 0, 'config', 'config_stock_checkout', '0', 0),
	(827, 0, 'config', 'config_stock_warning', '0', 0),
	(826, 0, 'config', 'config_stock_display', '0', 0),
	(825, 0, 'config', 'config_api_id', '1', 0),
	(824, 0, 'config', 'config_fraud_status_id', '16', 0),
	(823, 0, 'config', 'config_complete_status', '["3","5"]', 1),
	(822, 0, 'config', 'config_processing_status', '["2","3","1","12","5"]', 1),
	(821, 0, 'config', 'config_order_status_id', '1', 0),
	(820, 0, 'config', 'config_checkout_id', '5', 0),
	(819, 0, 'config', 'config_checkout_guest', '1', 0),
	(818, 0, 'config', 'config_cart_weight', '1', 0),
	(817, 0, 'config', 'config_invoice_prefix', 'INV-2020-00', 0),
	...
	(811, 0, 'config', 'config_customer_search', '0', 0),
	(810, 0, 'config', 'config_customer_activity', '0', 0),
	(809, 0, 'config', 'config_customer_online', '0', 0),
	(808, 0, 'config', 'config_tax_customer', 'shipping', 0),
	(807, 0, 'config', 'config_tax_default', 'shipping', 0),
	(806, 0, 'config', 'config_tax', '1', 0),
	(805, 0, 'config', 'config_voucher_max', '1000', 0),
	(804, 0, 'config', 'config_voucher_min', '1', 0),
	(803, 0, 'config', 'config_review_guest', '1', 0),
	(802, 0, 'config', 'config_review_status', '1', 0),
	(801, 0, 'config', 'config_limit_admin', '20', 0),
	(800, 0, 'config', 'config_product_count', '1', 0),
	(799, 0, 'config', 'config_weight_class_id', '1', 0),
	(798, 0, 'config', 'config_length_class_id', '1', 0),
	(797, 0, 'config', 'config_currency_auto', '1', 0),
	(796, 0, 'config', 'config_currency', 'RUB', 0),
	(795, 0, 'config', 'config_admin_language', 'ru-ru', 0),
	(794, 0, 'config', 'config_language', 'ru-ru', 0),
	(793, 0, 'config', 'config_zone_id', '2761', 0),
	(792, 0, 'config', 'config_country_id', '176', 0),
	(791, 0, 'config', 'config_comment', '', 0),
	(790, 0, 'config', 'config_open', '', 0),
	(789, 0, 'config', 'config_image', '', 0),
	(788, 0, 'config', 'config_fax', '', 0),
	(787, 0, 'config', 'config_telephone', '123456789', 0),
	(785, 0, 'config', 'config_geocode', '', 0),
	(786, 0, 'config', 'config_email', 'gorely.aleksei@yandex.ru', 0),
	(784, 0, 'config', 'config_address', 'Адрес', 0),
	(783, 0, 'config', 'config_owner', 'Ваш магазин', 0),
	(782, 0, 'config', 'config_name', 'Ваш магазин', 0),
	(781, 0, 'config', 'config_layout_id', '4', 0),
	(777, 0, 'config', 'config_meta_title', 'atvdoc', 0),
	(778, 0, 'config', 'config_meta_description', 'Запасные части, экипировка и аксессуары для мотоциклов, снегоходов, ATV и скутеров, гидроциклов.', 0),
	(780, 0, 'config', 'config_theme', 'atvdoc', 0),
	(779, 0, 'config', 'config_meta_keyword', 'ATV,UTV, скутер, мотоцикл, снегоход, мотор, запчасти, аксессуары,гидроцыкл, Брянск, ATVDOC, АТВДОК', 0),
	(630, 0, 'theme_default', 'theme_default_status', '1', 0),
	(629, 0, 'theme_default', 'theme_default_directory', 'atvdoc', 0),
	(656, 0, 'developer', 'developer_sass', '1', 0),
	(657, 0, 'theme_atvdoc', 'theme_atvdoc_directory', 'atvdoc', 0),
	(658, 0, 'theme_atvdoc', 'theme_atvdoc_status', '1', 0),
	(659, 0, 'theme_atvdoc', 'theme_atvdoc_product_limit', '15', 0),
	(660, 0, 'theme_atvdoc', 'theme_atvdoc_product_description_length', '100', 0),
	(661, 0, 'theme_atvdoc', 'theme_atvdoc_image_category_width', '80', 0),
	(662, 0, 'theme_atvdoc', 'theme_atvdoc_image_category_height', '80', 0),
	(663, 0, 'theme_atvdoc', 'theme_atvdoc_image_manufacturer_width', '80', 0),
	(664, 0, 'theme_atvdoc', 'theme_atvdoc_image_manufacturer_height', '80', 0),
	(665, 0, 'theme_atvdoc', 'theme_atvdoc_image_thumb_width', '228', 0),
	(666, 0, 'theme_atvdoc', 'theme_atvdoc_image_thumb_height', '228', 0),
	(667, 0, 'theme_atvdoc', 'theme_atvdoc_image_popup_width', '500', 0),
	(668, 0, 'theme_atvdoc', 'theme_atvdoc_image_popup_height', '500', 0),
	(669, 0, 'theme_atvdoc', 'theme_atvdoc_image_product_width', '228', 0),
	(670, 0, 'theme_atvdoc', 'theme_atvdoc_image_product_height', '228', 0),
	(671, 0, 'theme_atvdoc', 'theme_atvdoc_image_additional_width', '74', 0),
	(672, 0, 'theme_atvdoc', 'theme_atvdoc_image_additional_height', '74', 0),
	(673, 0, 'theme_atvdoc', 'theme_atvdoc_image_related_width', '80', 0),
	(674, 0, 'theme_atvdoc', 'theme_atvdoc_image_related_height', '80', 0),
	(675, 0, 'theme_atvdoc', 'theme_atvdoc_image_compare_width', '90', 0),
	(676, 0, 'theme_atvdoc', 'theme_atvdoc_image_compare_height', '90', 0),
	(677, 0, 'theme_atvdoc', 'theme_atvdoc_image_wishlist_width', '47', 0),
	(678, 0, 'theme_atvdoc', 'theme_atvdoc_image_wishlist_height', '47', 0),
	(679, 0, 'theme_atvdoc', 'theme_atvdoc_image_cart_width', '47', 0),
	(680, 0, 'theme_atvdoc', 'theme_atvdoc_image_cart_height', '47', 0),
	(681, 0, 'theme_atvdoc', 'theme_atvdoc_image_location_width', '268', 0),
	(682, 0, 'theme_atvdoc', 'theme_atvdoc_image_location_height', '50', 0);
/*!40000 ALTER TABLE `oc_setting` ENABLE KEYS */;


-- Дамп структуры для таблица atvdoc.oc_shipping_courier
...
-- Дамп данных таблицы atvdoc.oc_shipping_courier: 7 rows
...
-- Дамп структуры для таблица atvdoc.oc_statistics
...
-- Дамп данных таблицы atvdoc.oc_statistics: 7 rows
...
-- Дамп структуры для таблица atvdoc.oc_stock_status
...
-- Дамп данных таблицы atvdoc.oc_stock_status: 8 rows
...
-- Дамп структуры для таблица atvdoc.oc_store
...
-- Дамп данных таблицы atvdoc.oc_tax_class: 2 rows
...
-- Дамп структуры для таблица atvdoc.oc_tax_rate
...
-- Дамп данных таблицы atvdoc.oc_tax_rate: 2 rows
...
-- Дамп структуры для таблица atvdoc.oc_tax_rate_to_customer_group
...
-- Дамп данных таблицы atvdoc.oc_tax_rate_to_customer_group: 2 rows
...
-- Дамп структуры для таблица atvdoc.oc_tax_rule
...
-- Дамп данных таблицы atvdoc.oc_tax_rule: 4 rows
...
-- Дамп структуры для таблица atvdoc.oc_theme
...
-- Дамп данных таблицы atvdoc.oc_user: 1 rows
DELETE FROM `oc_user`;
/*!40000 ALTER TABLE `oc_user` DISABLE KEYS */;
INSERT INTO `oc_user` (`user_id`, `user_group_id`, `username`, `password`, `salt`, `firstname`, `lastname`, `email`, `image`, `code`, `ip`, `status`, `date_added`) VALUES
	(1, 1, 'admin', '9e30d222103f0a7a4df553f6c205c9f1c655de62', 'tKdUVASBM', 'John', 'Doe', 'gorely.aleksei@yandex.ru', '', '', '127.0.0.1', 1, '2020-01-15 18:34:53');
/*!40000 ALTER TABLE `oc_user` ENABLE KEYS */;


-- Дамп структуры для таблица atvdoc.oc_user_group
...
-- Дамп данных таблицы atvdoc.oc_voucher_history: 0 rows
...
-- Дамп структуры для таблица atvdoc.oc_voucher_theme
...
-- Дамп данных таблицы atvdoc.oc_voucher_theme: 3 rows
...
-- Дамп структуры для таблица atvdoc.oc_voucher_theme_description
...
-- Дамп данных таблицы atvdoc.oc_voucher_theme_description: 3 rows
...
-- Дамп структуры для таблица atvdoc.oc_weight_class
...
-- Дамп данных таблицы atvdoc.oc_weight_class: 4 rows
...
-- Дамп структуры для таблица atvdoc.oc_weight_class_description
...
-- Дамп данных таблицы atvdoc.oc_weight_class_description: 8 rows
...
-- Дамп структуры для таблица atvdoc.oc_zone
...
-- Дамп данных таблицы atvdoc.oc_zone: 4 103 rows
DELETE FROM `oc_zone`;
...
-- Дамп структуры для таблица atvdoc.oc_zone_to_geo_zone
...
-- Дамп данных таблицы atvdoc.oc_zone_to_geo_zone: 109 rows
